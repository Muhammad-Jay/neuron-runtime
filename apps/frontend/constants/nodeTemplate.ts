import {
    ConditionNodeConfig, ContextNodeConfig,
    DebugNodeConfig,
    DecisionNodeConfig,
    HttpRequestNodeConfig, IntegrationNodeConfig, LLMNodeConfig, NodeConfigType, NodeType, OutputNodeConfig,
    RespondNodeConfig, TransformNodeConfig,
    TriggerNodeConfig
} from "@neuron/shared";
import {
    Zap,
...
const getBaseConfig = (label: string) => ({
    ...
    executionConfig: {
        retry: { enabled: false, maxAttempts: 3, delayMs: 1000, strategy: "fixed" as const },
