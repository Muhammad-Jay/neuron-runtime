...
import {createWorkflowRequest, getWorkflowsRequest} from "@/lib/api-client/client";
...
export function WorkflowProvider({ children }: { children: ReactNode }) {
    ...
    const [workflows, workflowsDispatcher] = useReducer(workflowsReducer, [] as WorkflowType[]);
    ...
    function workflowsReducer(state: WorkflowType[], action: WorkflowAction): WorkflowType[] {
        switch (action.type) {
